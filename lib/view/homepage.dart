...
import 'package:courses_orange/view/Quize%20Screen/WelcomScreen.dart';
import 'package:courses_orange/view/newcourses.dart';
import 'package:courses_orange/view/pagecategory.dart';
import 'package:courses_orange/view/pagewebd.dart';
  ...
  Widget _listCategory() {
    return Consumer(
        builder: ( context, watch, child) {
          final getviewcategot = watch(apigetCateg);
      return Container(
        height: 100,
            ...
            return GestureDetector(
              onTap: () {
                Navigator.of(context).pushReplacement(MaterialPageRoute(
                    builder: (BuildContext context) => pagewebd()));
              },
              child: Padding(
