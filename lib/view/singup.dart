    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Form(
          key: formKey,
          child: FutureBuilder(
              future:fetchregester(emailcontroller.text,passwordcontroller.text,namecontroller.text,phonecontroller.text,addresscontroller.text, context),
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  if (formKey.currentState!.validate()){
                    ...
                    fetchregester('{$emailcontroller}','{$passwordcontroller}','{$namecontroller}','{$phonecontroller}','{$addresscontroller}',context);
                  }
                },
                child: const Text(
                  " SIGN UP",
